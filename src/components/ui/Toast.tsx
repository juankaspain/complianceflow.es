...
export function Toast({ message, type = 'info', duration = 5000, onClose }: ToastProps) {
  ...
  return createPortal(
    ...
    >
      <div
        className={`flex items-start gap-3 rounded-lg border p-4 shadow-lg backdrop-blur ${getColors()}`}
      >
        ...
        <button
          ...
          className="flex-shrink-0 rounded-md opacity-70 transition-opacity hover:opacity-100"
        >
